  ...
  * */
  ...
  def main(args: Array[String]): Unit = {
    ...
    */
    ...
    comments(spark).write.json("f:/sparktest/recommend/ml1mresult/comments")
    /*
    *  [2]所有电影平均评分的排名 且评论人数超过150人
    */
    sum_rating(spark).where("sum_comments > 1000").show(20,false)
    sum_rating(spark).where("sum_comments > 1000").write
    .json("f:/sparktest/recommend/ml1mresult/ag_rating")
